...
:Tar-file:
    ...
    latest stable release (ase-3.16.1.tar.gz_) or the latest
    development snapshot (`<snapshot.tar.gz>`_).

    Unpack and make a soft link::

        $ tar -xf ase-3.16.1.tar.gz
        $ ln -s ase-3.16.1 ase
...
:Git clone:
    ...
    https://gitlab.com/ase/ase like this::
        ...
        $ git clone -b 3.16.1 https://gitlab.com/ase/ase.git
...
.. _ase-3.16.1.tar.gz: https://pypi.org/packages/source/a/ase/ase-3.16.1.tar.gz
